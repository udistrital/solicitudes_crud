...
set estado_tipo_solicitud_id_anterior = 3
where estado_tipo_solicitud_id_anterior = 14;

update solicitud.solicitud_evolucion_estado
set estado_tipo_solicitud_id = 3
...
update solicitud.estado set nombre = 'Para evaluación', codigo_abreviacion = 'PEV' where id = 2;
update solicitud.estado set nombre = 'Requiere modificación', codigo_abreviacion = 'RMO' where id = 3;
