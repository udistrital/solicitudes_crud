...
func init() {
    ...
    beego.GlobalControllerRouter["github.com/udistrital/solicitudes_crud/controllers:TrSolicitudCrearController"] = append(beego.GlobalControllerRouter["github.com/udistrital/solicitudes_crud/controllers:TrSolicitudCrearController"],
        beego.ControllerComments{
            Method: "Post",
            Router: "/",
            AllowHTTPMethods: []string{"post"},
